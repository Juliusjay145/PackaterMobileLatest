...
public class ServiceProfileAdapter extends BaseAdapter {

    Context context;
    ArrayList<ServiceProfileList> list;
    LayoutInflater inflater;

    public ServiceProfileAdapter(Context context,
                                 ArrayList<ServiceProfileList> list) {
        super();
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if(arg1==null)
        {
            arg1 = inflater.inflate(R.layout.service_profile_data, null);
            handler = new ServiceHandler();
            handler.name = arg1.findViewById(R.id.textView);
            handler.description = arg1.findViewById(R.id.textView6);
            handler.price = arg1.findViewById(R.id.sampletext);
        ...
        handler.description.setText(list.get(arg0).getDescription());
