...
public class ServiceAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<CateringServiceList> list;
    LayoutInflater inflater;

    public ServiceAdapter(Context context, ArrayList<CateringServiceList> list) {
        super();
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if(arg1==null)
        {
            arg1 = inflater.inflate(R.layout.service_data, null);
            handler = new ServiceHandler();
            handler.name =  arg1.findViewById(R.id.textView2);
            handler.price = arg1.findViewById(R.id.textView);
